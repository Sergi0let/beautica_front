...
const About = () => {
  return (
    <section className="wrap-secondary mb-16 overflow-hidden pt-20 md:mb-6">
      <div className="relative h-[700px] rounded-4xl bg-(image:--bg-pattern) pt-10 text-white md:px-3 lg:h-[800px] lg:px-5 lg:pt-14">
        <div className="grid lg:grid-cols-[0.91fr_0.78fr_0.9fr]">
          ...
          <div className="order-1 lg:order-2">
            <h2
              data-fade
              id={ANCHORS.about}
              className="font-source-serif-pro scroll-mt-20 text-center text-2xl lg:scroll-mt-24 lg:text-5xl xl:text-[60px]"
            >
              Про мене
            </h2>
          </div>
        ...
        <ul className="absolute right-5 bottom-5 left-5 z-20 grid gap-2 text-sm md:grid-cols-3 lg:text-xl xl:gap-16">
          <li
            ...
            className="flex items-center gap-2 rounded-xl border border-solid border-white/30 px-5 py-4 backdrop-blur-md xl:px-6 xl:py-7"
          >
