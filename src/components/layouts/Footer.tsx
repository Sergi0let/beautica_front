    ...
    <section className="wrap-secondary relative w-full overflow-hidden">
      <div className="grid rounded-4xl bg-(image:--bg-pattern) pt-6 text-white lg:grid-cols-2">
        <div className="mx-auto">
          <div className="bottom-0 left-30 max-w-[240px] lg:absolute lg:max-w-[360px] xl:-bottom-20 xl:max-w-[438px]">
            <Image src="/footer/1.webp" alt="footer-image" width={438} height={743} />
          </div>
        </div>
        <div className="mx-auto mb-6 max-w-[665px] lg:mx-4">
          <div className="border-action mx-4 rounded-2xl border pt-5 md:pt-8">
            <h2 className="font-source-serif-pro mx-auto px-5 text-center text-2xl leading-none min-[1100px]:px-20 sm:text-3xl md:text-4xl lg:text-5xl">
              Підкресліть свою чарівність
            </h2>
            <p className="text-secondary-foreground mx-auto mt-2 mb-3 px-4 text-center text-sm font-normal min-[1100px]:px-20 md:mb-4 md:text-base">
            ...
            <nav className="m-5 flex flex-col flex-wrap justify-between gap-4 text-sm font-semibold md:flex-row md:text-base">
              <a href={phone?.href} className="flex flex-nowrap items-center">
