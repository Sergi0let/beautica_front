  ...
  return (
    <section className="wrap-secondary mb-16 md:mb-20 lg:mb-[120px]">
      <div className="rounded-4xl bg-(image:--bg-pattern) pt-8 pb-8 md:pt-12 md:pb-20 lg:pt-20">
        <h2
          data-fade
          className="font-source-serif-pro mt-6 mb-6 scroll-mt-16 text-center text-2xl leading-none text-white sm:text-5xl md:scroll-mt-20 lg:mb-10 lg:flex lg:text-left xl:text-[60px]"
        >
