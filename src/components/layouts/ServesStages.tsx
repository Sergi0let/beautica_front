        ...
        <div className="px-4 py-[40px] md:px-2 lg:py-[80px]">
          <div className="w-full">
            <h2
              data-fade
              id={ANCHORS.stages}
              className="font-source-serif-pro scroll-mt-20 text-center text-2xl leading-none text-white sm:text-5xl lg:scroll-mt-28 xl:text-[60px]"
            >
              Етапи проведення
            </h2>
          </div>
          ...
          <div className="relative flex flex-col items-center lg:block">
            <div data-fade style={{ transitionDelay: "0.8s" }} className="stage-decor" />
            <ul className="stage-list">
              {stages.map((item, index) => (
                <li data-fade style={{ transitionDelay: `${(index + 1) * 0.1}s` }} key={index} className="stage-item">
                  <div>
