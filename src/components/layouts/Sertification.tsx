    ...
    <section>
      <div className="wrap mt-10 mb-16 md:mb-20">
        <div data-fade className="flex w-full items-center justify-center">
          <h2 className="font-source-serif-pro text-accent-foreground mb-6 scroll-mt-16 text-justify text-2xl leading-none sm:text-5xl md:mb-[50px] md:w-[67%] md:scroll-mt-20 md:indent-[58px] lg:indent-[158px] xl:indent-[258px] xl:text-[60px]">
        ...
        <div className="relative mx-auto flex flex-col-reverse sm:mr-0 md:flex-row md:pr-4">
          <ul className="relative mt-12 flex justify-between md:z-10 md:mt-0 md:block md:w-2/12 md:bg-white">
            {sertificateData.amouts.map(({ id, value, name }) => (
              <li key={id} className="">
                <span className="font-source-serif-pro text-accent-foreground relative text-[64px] leading-none md:text-[140px]">
