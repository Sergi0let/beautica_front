  ...
  return (
    <DrawerPortal data-slot="drawer-portal">
      ...
      <DrawerPrimitive.Content
        ...
        className={cn(
          "group/drawer-content bg-background fixed z-50 flex h-auto flex-col outline-none focus:outline-none",
        ...
        {...props}
      >
        <div className="mx-auto mt-2 hidden h-1 w-[100px] shrink-0 rounded-full bg-pink-50 group-data-[vaul-drawer-direction=bottom]/drawer-content:block" />
